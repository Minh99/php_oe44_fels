...
@section('content')
<div class="pcoded-content" style="height: 100vh;">
  ...
  <div class="pcoded-inner-content">
    ...
    <div class="main-body">
      <div class="page-wrapper">
        ...
        @else
        <div class="page-body">
          <h5 class="text-dark">Courses of currently studying</h5>
          <hr>
          <div class="row">
            @if(count($listMyCourse) == 0)
            <p class="text-center w-100">You don't have any courses yet. <a class="text-danger" href="{{route('other.courses')}}">[view courses]</a></p>
            @else
            @foreach($listMyCourse as $items)
            @foreach($items as $value)

            <div class="col-xl-4 col-md-6 row mt-4">
              <div class="card mb-0">
